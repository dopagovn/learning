...
<div class="container">
    ...
    <form class="register" method="POST" action="./backend/xulyReg.php">
        ...
        <div class="register__row">
            <div>
                ...
                <div class="birthday">
                    <input class="textbox" type="text" name="birthday" value="1/1/1900">
        ...
        <div class="register__row register__row--1">
            <div>
                ...
                <input class="textbox" type="password" name="re-password">
            </div>
        </div>
        <div class="register__row register__row--1">
            <div>
                <p class="title">Số điện thoại</p>
                <input class="textbox" type="text" name="pNumber">
            </div>
        </div>
        <div class="register__row register__row--1">
            <div>
